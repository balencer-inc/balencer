# 1st PLACE 村山様 商談メモ（2026-06）

> 2026-06-22 オンライン商談に向けて作成した資料索引・方針メモ。
> 当時のブランチ `claude/tsugi-ma-hearing` / `claude/ai-training-proposal` から 2026-08-17 に回収。
> 顧客の概要は [README.md](README.md) を参照。
